...
public class Main {
    ...
    public class ALU {
        ...
        public DataType mul(DataType src, DataType dest) {
            ...
            for (int i = 31; i > 0; i--) {
                if (i == 31) {
                    ac[i] = (-Integer.parseInt(String.valueOf(mul2.charAt(i))));
                } else {
                    ac[i] = (Integer.parseInt(String.valueOf(mul2.charAt(i))) - Integer.parseInt(String.valueOf(mul2.charAt(i - 1))));
                }
            }
            ...
            for (int i = 31; i >= 0; i--) {
                ...
                if (ac[i] == -1) {
                    ...
                    String num = sub(new DataType(String.valueOf(tmp)), src).toString();
                    for (int j = 0; j < 32; j++) {
                        ans[j] = num.charAt(j);
                    }
                }
